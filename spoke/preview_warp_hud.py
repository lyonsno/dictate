...
_PREFS_PATH = Path.home() / "Library" / "Application Support" / "Spoke" / "preview_warp_hud.json"
_PANEL_WIDTH = 380.0
_PANEL_HEIGHT = 480.0
_PADDING_X = 14.0
_ROW_HEIGHT = 48.0
...
class PreviewWarpHUD(NSObject):
    ...
    def setup(self) -> None:
        ...
        reset_button = NSButton.alloc().initWithFrame_(NSMakeRect(_PANEL_WIDTH - 96.0, _PANEL_HEIGHT - 42.0, 80.0, 24.0))
        ...
        for index, (title_text, key, min_value, max_value, fmt) in enumerate(_SLIDER_SPECS):
