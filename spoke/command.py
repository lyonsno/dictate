...
_SYSTEM_PROMPT = (
    ...
    "Before performing git operations in the Epistaxis repo (merge, push, "
    "branch cleanup, resolving divergence), read the runbook at "
    "~/dev/spoke/docs/epistaxis-git-runbook.md with the read_file tool "
