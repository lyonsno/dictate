...
_SYSTEM_PROMPT = (
    ...
    "- compact_history: shed stale tool results from conversation history. "
    "Use drop_tool_results mode to strip tool messages from oldest N turns, "
    "or summarize mode to replace them with a brief summary.\n\n"
