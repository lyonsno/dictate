...
_SYSTEM_PROMPT = (
    ...
    "You also have search_web: a bounded read-only web search tool. Use it "
    "when the user asks about current public information and the answer is "
    "not already available from local files.\n\n"
