...
This module owns the House-level materialize/rest/dismiss math.  Consumers may
bring their own shell geometry and client identity, but the pressure-slit
grammar itself lives here instead of in a private overlay implementation.
"""
...
PRESSURE_SLIT_SMOKE_TIME_SCALE = 2.0 / 3.0
