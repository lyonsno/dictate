...
def build_agent_shell_primitives(
    ...
    This is a contract adapter: it consumes card truth and display semantics,
    then emits serializable primitive data. It does not own layout, material
    execution, provider state, or transcript scraping.
    """
