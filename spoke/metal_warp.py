...
# Shared with backdrop_stream.py so both renderers stay visually aligned.
...
_WARP_CURVEBOOST_MAG_SCALE = _warp_tuning.WARP_CURVEBOOST_MAG_SCALE
_WARP_CURVEBOOST_RING_DIVISOR = _warp_tuning.WARP_CURVEBOOST_RING_DIVISOR
_WARP_CURVEBOOST_RING_CAP = _warp_tuning.WARP_CURVEBOOST_RING_CAP
...
_WARP_EXTERIOR_MAG_STRENGTH = _warp_tuning.WARP_EXTERIOR_MAG_STRENGTH
_WARP_EXTERIOR_MAG_DECAY = _warp_tuning.WARP_EXTERIOR_MAG_DECAY
