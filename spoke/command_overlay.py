...
_COMMAND_BACKDROP_OPTICAL_SHELL_EXTERIOR_MIX_WIDTH_POINTS = _env(
    "SPOKE_COMMAND_BACKDROP_OPTICAL_SHELL_EXTERIOR_MIX_WIDTH_POINTS", 20.0
)
_COMMAND_BACKDROP_OPTICAL_SHELL_BLEED_ZONE_FRAC = _env(
    "SPOKE_COMMAND_BACKDROP_OPTICAL_SHELL_BLEED_ZONE_FRAC", 0.4
)
...
def _command_optical_shell_config(
    ...
    return {
        ...
        "exterior_mix_width_points": _COMMAND_BACKDROP_OPTICAL_SHELL_EXTERIOR_MIX_WIDTH_POINTS,
        "bleed_zone_frac": _COMMAND_BACKDROP_OPTICAL_SHELL_BLEED_ZONE_FRAC,
